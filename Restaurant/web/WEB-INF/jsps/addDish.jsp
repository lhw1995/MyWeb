    ...
    <div class="contact">
        <div class="contact-form">
            <div class="col-md-8 contact-grid">
                <form id="addDishForm" onsubmit="return checkSubmit()" action="${pageContext.request.contextPath}/restaurant/dish"  method="post" enctype="multipart/form-data">
                    <input type="text" placeholder="菜品名" name="dishName"/>
                    ...
                    <input type="text" placeholder="类型" name="classify"/>
                    ...
                    <input type="text" placeholder="库存" name="inventory"/>
                    ...
                    <div id="coverImag">
                        ...
                        <div class="clearfix"> </div>
                        <img id="coverImagPr" height="200" width="200" src="${pageContext.request.contextPath}/images/food/面食/兰州牛肉面.jpg"/>
                    </div>
