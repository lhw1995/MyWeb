        ...
        <div class="contact-form">
            <div class="col-md-8 contact-grid">
                <form id="changeInfoForm" action="${pageContext.request.contextPath}/restaurant/consumerinfo" onsubmit="return checkSubmit()" method="post" enctype="multipart/form-data">
                    <input type="text" placeholder="显示名" name="showName" value="${sessionScope.loginUser.showName}"/>
                    ...
                    <input type="text" placeholder="手机" name="phone" value="${sessionScope.loginUser.phone}"/>
                    ...
                    <div id="localImag">
                        <img id="ImgPr" height="120" width="120" src="${pageContext.request.contextPath}${sessionScope.loginUser.headPortrait}"/>
                    </div>


                    <input type="file" name="chooseHeadFile" id="up" value="修改头像" onchange="upload()"/>
